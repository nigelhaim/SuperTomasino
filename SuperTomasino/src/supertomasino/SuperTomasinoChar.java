...
public class SuperTomasinoChar {
    ...
    public void Wave(Graphics2D g2d){
        clearCanvas(g2d);
        g2d.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
        g2d.setStroke(new BasicStroke(3));

        //Head 
        Rectangle2D.Double Skin1 = new Rectangle2D.Double(95, 67, 309, 185);
        g2d.setColor(skin);
        g2d.fill(Skin1);

        //LeftEar
        GeneralPath LeftEar = new GeneralPath();
        LeftEar.moveTo(64, 97);
        LeftEar.lineTo(125, 97);
        LeftEar.lineTo(125, 192);
        LeftEar.lineTo(95, 192);
        LeftEar.lineTo(95, 158);
        LeftEar.lineTo(64, 158);
        LeftEar.closePath();
        g2d.setColor(skin);
        g2d.fill(LeftEar);
        ...
        //Eye
        Rectangle2D.Double EyeLeft = new Rectangle2D.Double(156, 67, 30, 63);
        g2d.setColor(BLACK);
        g2d.fill(EyeLeft);

        Rectangle2D.Double EyeRight = new Rectangle2D.Double(250, 67, 30, 63);
        g2d.setColor(BLACK);
        g2d.fill(EyeRight);


        //Sideburns
        Rectangle2D.Double SideburnLeft = new Rectangle2D.Double(95, 67, 31, 63);
        g2d.setColor(BLACK);
        g2d.fill(SideburnLeft);

        Rectangle2D.Double SideburnRight = new Rectangle2D.Double(310, 67, 31, 63);
        g2d.setColor(BLACK);
        g2d.fill(SideburnRight);

        //Beard
        GeneralPath Beard = new GeneralPath();
        Beard.moveTo(126, 130);
        Beard.lineTo(156, 130);
        Beard.lineTo(156, 160);
        Beard.lineTo(185, 160);
        Beard.lineTo(185, 190);
        Beard.lineTo(250, 190);
        Beard.lineTo(250, 160);
        Beard.lineTo(280, 160);
        Beard.lineTo(280, 130);
        Beard.lineTo(310, 130);
        Beard.lineTo(310, 190);
        Beard.lineTo(279, 190);
        Beard.lineTo(279, 220);
        Beard.lineTo(156, 220);
        Beard.lineTo(156, 190);
        Beard.lineTo(126, 190);
        Beard.closePath();
        g2d.setColor(BLACK);
        g2d.fill(Beard);
